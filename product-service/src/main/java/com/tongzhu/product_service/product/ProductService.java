...
import static com.tongzhu.product_service.RabbitUtil.*;
...
public class ProductService {
    ...
    public void hearOrder(String string) throws JsonProcessingException {
        ...
        rabbitTemplate.convertAndSend("response_queue",
                convertToString(new RequestDTO(uuid, itemsDTO, orderStatus)));
